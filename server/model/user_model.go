...
import (
	...
	"github.com/zhime/blog/server/model/ctype"
)
...
type UserModel struct {
	...
	ArticleModel []ArticleModel     `json:"article_models" gorm:"foreignKey:ArticleID;comment:发布的文章列表"`
	CollectModel []UserCollectModel `json:"collect_models" gorm:"many2many:user_collect_model;comment:收藏的文章列表"`
}
